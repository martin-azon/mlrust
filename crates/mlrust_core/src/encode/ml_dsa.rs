//! ML-DSA coefficient compression and decompression.
//!
//! This module implements the coefficient-level compression primitives used by
//! ML-DSA over the modulus `q = 8380417`.


use crate::params::{Q8380417, RingParams, N};
...
mod tests {
    ...
    fn coeff_from_three_bytes_ignores_high_bit_of_third_byte() {
        ...
        assert_eq!(a.is_some().unwrap_u8(), 1);
        assert_eq!(b.is_some().unwrap_u8(), 1);
