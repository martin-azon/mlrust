...
use super::q3329_tables::{FIPS_BASEMUL_ZETAS_MONT, FIPS_ZETAS_MONT, INV_NTT_SCALE_MONT};
use crate::field::{add_mod, mul_montgomery, sub_mod};
use crate::params::{N, NttDomainMul, NttOps, NttParams, Q3329, RingParams};
...
/// ```
pub fn base_mul<P: RingParams>(a0: i32, a1: i32, b0: i32, b1: i32, zeta_mont: i32) -> (i32, i32) {
...
mod tests {
    ...
    fn assert_poly_eq_canonical(got: Poly<Q3329>, expected: Poly<Q3329>) {
    ...
    fn montgomery_product_roundtrip_q3329() {
        ...
        for &a in &test_values {
            for &b in &test_values {
                ...
                let prod_mont = Q3329::montgomery_reduce((a_mont as i64) * (b_mont as i64));

                let got = Q3329::freeze(Q3329::from_montgomery(prod_mont));
                let expected = ((a as i64) * (b as i64)).rem_euclid(Q3329::Q as i64) as i32;
    ...
    fn ntt_mul_sparse_wraparound_matches_schoolbook_q3329() {
        let a = make_sparse_poly(&[(0, 12), (1, -7), (127, 5), (200, -9), (255, 4)]);

        let b = make_sparse_poly(&[(0, -3), (2, 8), (56, -6), (128, 7), (255, -5)]);
