...
use crate::params::{N, NttDomainMul, NttOps, NttParams, Q8380417, RingParams};
...
fn ntt_in_place_q8380417(a: &mut [i32; N]) {
...
fn inv_ntt_in_place_q8380417(a: &mut [i32; N]) {
    let mut m = 256usize;
    let mut len = 1usize;
    ...
    fn montgomery_product_roundtrip_q8380417() {
        ...
        for &a in &test_values {
            for &b in &test_values {
                ...
                let prod_mont = Q8380417::montgomery_reduce((a_mont as i64) * (b_mont as i64));

                let got = Q8380417::freeze(Q8380417::from_montgomery(prod_mont));
                let expected = ((a as i64) * (b as i64)).rem_euclid(Q8380417::Q as i64) as i32;
